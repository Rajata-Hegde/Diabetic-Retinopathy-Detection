    ...
    const html = `
      <html>
        ...
        <body>
          <div class="page">
            <div class="header">
              <div class="brand">RetinaCare<span>.</span></div>
              <div class="meta">
            ...
            <div class="footer">
              CONFIDENTIAL MEDICAL RECORD • GENERATED BY RETINACARE AI SUITE • NOT A REPLACEMENT FOR PROFESSIONAL CLINICAL ADVICE
            </div>
          </div>
          <script>
            window.onload = () => {
